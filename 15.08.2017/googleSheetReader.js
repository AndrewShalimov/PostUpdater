...
function getPostsData(getPostsData_callback) {
    fs.readFile('app_config.json', function processClientSecrets(err, content) {
        ...
        // Google Sheets API.
        googleConfig = JSON.parse(content);
        authorize(googleConfig, listFiles, getPostsData_callback, googleConfig.postsUpdate.sheetId,
                                                                  googleConfig.postsUpdate.sheetName,
                                                                  googleConfig.postsUpdate.range);
    });
}
